...
A: ツール自体は無料ですが、Gemini APIの利用料金（1セット30円〜50円程度）がかかります。料金は変動するので、1枚作ってみて24時間後の料金反映を確かめてから量産してください。
...
> **注意：** 無料枠では画像生成できません。1セット30円〜50円程度かかります（状況により変動するので、1枚作ってみて24時間後の料金反映を確かめてから量産するようにしてください）。
